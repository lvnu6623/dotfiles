# Generated by Powerlevel10k configuration wizard on 2022-04-12 at 16:41 JST.
...
() {
  ...
  # Grey nodeenv/nvm environment.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=$grey
  
  # Show on node.js project only
  typeset -g POWERLEVEL9K_NODE_VERSION_PROJECT_ONLY=true

  # add nodeenev/nvm bracktes.
